...
public class SistemPencucianMobil {
    ...
    private static void updatePelanggan() {
        ...
        for (Pelanggan pelanggan : pelangganList) {
            if (pelanggan.idPelanggan.equals(idPelanggan)) {
                System.out.print("Masukkan Nama baru: ");
                pelanggan.nama = scanner.nextLine();
                System.out.print("Masukkan Nomor Telepon baru: ");
                pelanggan.nomorTelepon = scanner.nextLine();
                System.out.print("Masukkan History Pemesanan baru: ");
                pelanggan.historyPemesanan = scanner.nextLine();
